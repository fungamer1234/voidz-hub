...
local BUILD = _Vzd({87,85,87,91,82,85,92,82,87,93,82,86,83,87,83,87,89})
...
function startSnowFarm()
	...
	task.spawn(function()
		...
		while S._snowFarmOn do
			...
			if grown >= want then
				stopSnowFarm(true)
				notify(HUB_NAME, "Grown " .. grown .. _Vzd({69,161,69,139,145,142,147,140,69,148,151,69,138,157,149,145,148,137,138}), 2.5)
				break
			end
			if have < want then
...
_TAB_BUILDERS["anti"] = function(sc, n)
		...
		makeToggle(sc, { order = n(), id = _Vzd({134,147,153,142,107,145,142,147,140}), title = "Anti-Fling", tip = _Vzd({127,138,151,148,69,138,157,153,151,138,146,138,69,155,138,145,148,136,142,153,158}), callback = function(on)
			stopLoop("antiFling")
		...
		makeToggle(sc, { order = n(), id = _Vzd({134,147,153,142,120,142,153}), title = "Anti-Sit / Seat Trap", tip = "Force unsit", callback = function(on)
			stopLoop("antiSit")
...
_TAB_BUILDERS["loop"] = function(sc, n)
		...
		local loops = {
			{ id = _Vzd({145,148,148,149,107,145,142,147,140}), title = _Vzd({112,138,138,149,69,121,141,151,148,156,142,147,140}), tip = _Vzd({102,147,147,148,158,142,147,140,69,136,148,147,152,153,134,147,153,69,139,145,142,147,140,69,161,69,146,134,149,82,156,142,137,138}), waitRespawn = true, fn = function(p)
			...
			{ id = _Vzd({145,148,148,149,119,134,140,137,148,145,145}), title = "Keep Ragdolling", tip = _Vzd({120,149,134,146,69,151,134,140,137,148,145,145,69,161,69,146,134,149,82,156,142,137,138}), waitRespawn = true, fn = function(p) ragdoll(p, true) end },
			...
			{ id = _Vzd({145,148,148,149,117,148,142,152,148,147}), title = _Vzd({113,148,148,149,69,117,148,142,152,148,147}), tip = "Poison | map-wide", fn = function(p) applyStatusToPlayer(_Vzd({149,148,142,152,148,147}), p) end },
...
_TAB_BUILDERS[_Vzd({153,151,134,147,152})] = function(sc, n)
		...
		makeDropdown(sc, {
			...
			options = { "English", "Spanish", _Vzd({107,151,138,147,136,141}), "German", "Portuguese", "Japanese", "Korean", "Chinese", "Russian", _Vzd({102,151,134,135,142,136}), "Italian", "Hindi" },
...
_TAB_BUILDERS["fun"] = function(sc, n)
		...
		local SPARK_TOYS = { "Firework", "Balloon", "Snowball", "BombBalloon", "CandyCorn", "WaterBomb", "Pumpkin", _Vzd({117,151,138,152,138,147,153}) }
		...
		makeButton(sc, {
			...
			callback = function()
				...
				notify(HUB_NAME, _Vzd({120,149,134,151,144,145,138,151,69,135,154,151,152,153,69,77}) .. (S.sparkShape or _Vzd({120,149,141,138,151,138})) .. " x " .. amount .. _Vzd({78,69,83,69,152,138,151,155,138,151}), 1.2)
			end,
		})
		makeToggle(sc, {
