...
```lua
loadstring(game:HttpGet("https://raw.githubusercontent.com/fungamer1234/voidz-hub/main/VOIDZ_HUB.lua?v=1.2.83", true))()
```

Build: `2026-07-28-1.2.83` · Access Key: `VOIDZHUB`  
**Must use `?v=1.2.83`** or you may still get an old cached script.
