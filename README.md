...
Build: `2026-07-29-1.2.112` · Access Key: `VOIDZHUB`  
...
Public `VOIDZ_HUB.lua` is **fully obfuscated** on every release (strings encoded, comments stripped, internals renamed). Clean source stays private.

## Recent (1.2.112)

- **Harder public obfuscation** — Every GitHub update is auto-obfuscated (anti casual steal/edit).
