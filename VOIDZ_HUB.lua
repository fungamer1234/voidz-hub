...
local AURA_META = {
	...
	{ id = _Vzd({135,151,142,147,140}), title = "Bring Nearby", tip = _Vzd({103,151,142,147,140,69,147,138,134,151,135,158,69,149,145,134,158,138,151,152,69,142,147,69,139,151,148,147,153,69,148,139,69,158,148,154,69,77,149,151,148,157,142,146,142,153,158,78,83}) },
...
function isFlingMoverName(n)
	...
	return n == "FlingAuraVelocity" or n == "SkyVelocity" or n == "KickAuraP" or n == "KickAuraP1"
		or n == _Vzd({112,142,136,144,102,154,151,134,108}) or n == _Vzd({123,116,110,105,127,132,103,123}) or n == "VOIDZ_VoidBV" or n == "BringBody"
...
function gucciReclaimSelf()
	...
	for _, n in ipairs({ "HumanoidRootPart", "Head", "Torso", "UpperTorso", "LowerTorso",
		...
		"LeftUpperLeg", _Vzd({119,142,140,141,153,122,149,149,138,151,113,138,140}), _Vzd({113,138,139,153,113,148,156,138,151,113,138,140}), "RightLowerLeg" }) do
		local p = c:FindFirstChild(n)
		if p and p:IsA("BasePart") then
			sno(p, me.Position)
			pcall(function()
...
local KNOWN_TOYS = {
	...
	"BombBalloon", "BombDarkMatter", _Vzd({103,148,146,135,114,142,152,152,142,145,138}), _Vzd({103,148,148,144,114,134,147,158,117,134,140,138,152}), "BookNormal",
	...
	"DrawerLightBrown", "FactoryBench", _Vzd({107,134,136,153,148,151,158,104,134,135,142,147,138,153}), "FactoryChair", "FactoryCouch",
...
local SUSPICIOUS_NAMES = {
	...
	"blitz", _Vzd({138,147,137,148,151,142,152}), _Vzd({149,148,148,149,141,154,135}), "nameless", "script-ware", "synapse", _Vzd({137,151,134,156,142,147,140}),
...
_TAB_BUILDERS[_Vzd({153,151,134,147,152})] = function(sc, n)
		...
		makeDropdown(sc, {
			...
			options = { "English", "Spanish", "French", _Vzd({108,138,151,146,134,147}), "Portuguese", "Japanese", _Vzd({112,148,151,138,134,147}), _Vzd({104,141,142,147,138,152,138}), _Vzd({119,154,152,152,142,134,147}), "Arabic", "Italian", _Vzd({109,142,147,137,142}) },
