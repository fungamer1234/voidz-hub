...
local BUILD = _Vzd({87,85,87,91,82,85,92,82,87,93,82,86,83,87,83,92,88})
...
local KNOWN_TOYS = {
	...
	"FoodBanana", "NinjaKunai", _Vzd({117,134,145,145,138,153,113,142,140,141,153,103,151,148,156,147}), _Vzd({117,134,145,145,138,153}), _Vzd({120,149,151,134,158,104,134,147,124,105}),
...
local FORM_BUILDS = {
	{ id = _Vzd({141,138,134,151,153}), title = _Vzd({109,138,134,151,153}), tip = _Vzd({107,145,148,134,153,152,69,134,135,148,155,138,69,158,148,154,151,69,141,138,134,137,69,80,69,152,148,139,153,69,135,148,135}), offsets = formHeartOffsets, scale = 1.0, anchor = "head", anim = "bob" },
...
local SUSPICIOUS_NAMES = {
	...
	_Vzd({152,142,146,149,145,138,152,149,158}), "remote spy", "remotespy", _Vzd({156,142,147,137,154,142}), "linoria", "sirius", "bloody",
	"blitz", "endoris", "poophub", _Vzd({147,134,146,138,145,138,152,152}), "script-ware", "synapse", _Vzd({137,151,134,156,142,147,140}),
	"esp", _Vzd({136,141,134,146,152}), _Vzd({134,142,146,135,148,153}), "silentaim", _Vzd({139,151,138,138,136,134,146}), "noclip", "flybv", "bodyvelocity",
}
...
_TAB_BUILDERS["fun"] = function(sc, n)
		...
		local LIMB_JOINTS = { "Right Shoulder", _Vzd({113,138,139,153,69,120,141,148,154,145,137,138,151}), "Right Hip", _Vzd({113,138,139,153,69,109,142,149}), "Neck", _Vzd({119,148,148,153,111,148,142,147,153}) }
...
local function showImmediateKeyUI()
	...
	local function paintOutline(host, col, th)
		...
		local names = { "VOIDZ_OL_T", "VOIDZ_OL_B", _Vzd({123,116,110,105,127,132,116,113,132,113}), _Vzd({123,116,110,105,127,132,116,113,132,119}) }
