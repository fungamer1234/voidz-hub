...
```lua
loadstring(game:HttpGet("https://raw.githubusercontent.com/fungamer1234/voidz-hub/main/VOIDZ_HUB.lua?v=1.2.80", true))()
```

Build: `2026-07-28-1.2.80` · Access Key: `VOIDZHUB`  
**Must use `?v=1.2.80`** or you may still get an old cached script.
...
- **WAR MODE** — One toggle arms max anti stack (Gucci/Kill/Fling/Explode/Burn/Sticky/Void/God) + `voidzWarProtectBurst` loop (20x Struggle, multi StopAllVelocity, full heal, house TP). Antis cranked hard for hub wars.
