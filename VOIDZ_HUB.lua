...
local BUILD = _Vzd({87,85,87,91,82,85,92,82,87,94,82,86,83,87,83,86,86,89})
...
function startTrainDrive()
	...
	S._trainStableSit = true
	notify(HUB_NAME, _Vzd({120,138,134,153,138,137,69,152,153,134,135,145,138,69,148,147,69}) .. label .. " | FE claim…", 1.4)
